...
Refunds, shopping, selling, subscriptions.

Generated from [`data/shopping-commerce.json`](../data/shopping-commerce.json). Edit that file, then run `python3 scripts/render_catalog.py`.
